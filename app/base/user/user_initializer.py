...
class UserInitializer:
    ...
    def register_routes(self, app: FastAPI):
        ...
        app.get("/users/{user_id}", tags=["Get Methods"])(self.user_api.get_user)
        app.put("/users/{user_id}", tags=["Put Methods"])(self.user_api.update_user)
        app.delete("/users/{user_id}", tags=["Delete Methods"])(
            self.user_api.delete_user
        )
